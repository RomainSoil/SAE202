...
public class Monde {
    ...
    public void setTnbminerais1() {
        Tnbminerais1.setText(String.valueOf(mine1.getNbMinerais()));
    }

    public void setTnbminerais2() {
        Tnbminerais2.setText(String.valueOf(mine2.getNbMinerais()));
    }

    public void setTstockrob1() {
        Tstockrob1.setText(String.valueOf(robot1.getStockage()));
    }

    public void setTstockrob2() {
        Tstockrob2.setText(String.valueOf(robot2.getStockage()));
    }


    public void setTstockentrepot1() {
        Tstockentrepot1.setText(String.valueOf(entrepot1.getStock()));
    }

    public void setTstockentrepot2() {
        Tstockentrepot2.setText(String.valueOf(entrepot2.getStock()));
    }
    ...
    public GridPane affichageScore() {
        ...
        Text TA = new Text("  REGLES DU JEU" + AlaLigne + AlaLigne + "  Bonjour," + AlaLigne + "  Voici les règles du robot mineur :" + AlaLigne + "  Pour ce jeu, vous avez à votre disposition deux robots correspondant" + AlaLigne + "  à une mine en particulier," + AlaLigne + "  vous pouvez le remarquer juste au-dessus," + AlaLigne + "  NI pour le Nickel et OR pour l'Or." + AlaLigne + "  Vous pouvez également voir qu'au niveau des informations ci-dessus," + AlaLigne + "  vous avez à disposition le numéro de chaque mine," + AlaLigne + "  de chaque entrepôt et de chaque robot" + AlaLigne + "  ainsi que leurs coordonnées sur la Carte" + AlaLigne + "  et leur capacité de stockage de Minerais." + AlaLigne +
                ...
                + AlaLigne + AlaLigne + "  Vous avez aussi la posibilité de jouer  avec les touches du clavier" +AlaLigne+ "  Attention Vous ne pouvez pas mélanger les deux" + AlaLigne+ "  Commande : "
                + AlaLigne + "  X --> Robot 1  C --> Robot 2" +AlaLigne+"  Z --> Nord  S --> Sud" +AlaLigne+"  Q --> OUEST  D --> EST" +AlaLigne+" J--> Extraire K--> Deposer" );
